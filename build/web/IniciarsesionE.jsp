<%-- 
    Document   : IniciarsesionE
    Created on : 11-06-2021, 3:03:22
    Author     : Anilom
--%>
...
<html lang="en">
  ...
  <div class="container-fluid  ">
    ...
    <div class="mx-auto" style="text-align: center">
         ...
         <br>
          <br>
   <h1>Iniciar Sesión Entrenador </h1>
   <br> <br>
    ...
    -->
    <form method="POST" action="Servletentrenador">
  <center><div class="form-floating col-md-4 " style="width: 300px;" >
       <input type="text" class="form-control" id="iderut" maxlength="10" autofocus oninput="checkRut(this)" placeholder="Ingrese Rut"  name="erut">
  <label for="floatingInput">Ingrese Rut</label>
        </div>
    <br>
<div class="form-floating" style="width: 300px;">
    <input type="password" class="form-control" id="ideclave" maxlength="4" placeholder="clave" required name="eclave">
