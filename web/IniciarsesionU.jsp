<%-- 
    Document   : IniciarsesionU
    Created on : 11-06-2021, 2:08:31
    Author     : Anilom
--%>
...
<html lang="en">
  ...
  <center><div class="form-floating col-md-4 " style="width: 300px;">
       <input type="text" class="form-control" id="idurut" maxlength="10" autofocus oninput="checkRut(this)" placeholder="Ingrese Rut"  name="urut">
  <label for="floatingInput">Ingrese Rut</label>
        </div>
    <br>
<div class="form-floating" style="width: 300px;">
    <input type="password" class="form-control" id="iduclave" maxlength="4" placeholder="clave" required name="uclave">
